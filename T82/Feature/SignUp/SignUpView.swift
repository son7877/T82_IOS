        ...
        ScrollView {
            VStack {
                ...
                SecureField("비밀번호", text: $signUpContentViewModel.signUpContent.password)
                    ...
                    .focused($isFocused)
                    .textInputAutocapitalization(.never)
                    .onChange(of: signUpContentViewModel.signUpContent.password) { newValue, _ in
                        passwordValidationMessage = Validation.validatePassword(newValue)
                        passwordCheckValidationMessage = Validation.validatePasswordCheck(password: newValue, passwordCheck: signUpContentViewModel.signUpContent.passwordCheck)
                    }
                ...
                SecureField("비밀번호 확인", text: $signUpContentViewModel.signUpContent.passwordCheck)
                    ...
                    .focused($isFocused)
                    .textInputAutocapitalization(.never)
                    .onChange(of: signUpContentViewModel.signUpContent.passwordCheck) { newValue, _ in
                        passwordCheckValidationMessage = Validation.validatePasswordCheck(password: signUpContentViewModel.signUpContent.password, passwordCheck: newValue)
                    }
